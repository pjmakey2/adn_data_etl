...
MAP_CURRENCY = {
    ...
    u'PESOS URUGUAYOS': 'UYU',
    u'CORONAS DANESAS': 'DKK',
    u'BOLIVAR': 'VEB',
    u'CORONA CHECA': 'CZK',
    u'DIRHAM': 'AED',
    u'DOLAR DE TAIWAN': 'TWD',
    u'DRACMA': 'GRD (EURO)',
    u'FRANCOS BELGAS': 'BEF (EURO)',
    u'FRANCOS FRANCESES': 'FRF',
    u'HUNGRIA': 'HUF',
    u'ISRAEL': 'ILS',
    u'LIBRAS IRLANDESAS': 'IED',
    u'LIRAS TURCAS': 'TRY',
    u'PESETAS': 'ESP (EURO0',
    u'PESO BOLIVIANO': 'BOB',
    u'PESO COLOMBIANO': 'COP',
    u'RUPIA HINDU': 'INR',
    u'TAILANDIA': 'THB',
    u'WON COREA DEL SUR': 'KRW',
}
K_ORDER = [
    u'OFICIALIZACION',
    u'CANCELACION',    
